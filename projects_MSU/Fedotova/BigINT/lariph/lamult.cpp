...
const long_number LN_ZERO = {1, 1, const_cast<byte2*>(d_zero)};
const long_number LN_ONE  = {1, 1, const_cast<byte2*>(d_one)};
const long_number LN_MINUS_ONE = {1, -1, const_cast<byte2*>(d_one)};
